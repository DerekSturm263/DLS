	...
	class material : public core::interfaces::serializable<material> {
		private:
            class settings : public core::interfaces::serializable<settings> {
        		private:
		        	collections::types::map<miscellaneous::types::text, shader::any> _values;

        		public:
		        	collections::types::map<miscellaneous::types::text, shader::any> const& values() const {
				        return _values;
        			}
			
		        	collections::types::map<miscellaneous::types::text, shader::any>& values() {
				        return _values;
        			}
