	...
	class graphics : public core::types::system<functions::render<Decimal, Size>>, public core::interfaces::i_on_entity_spawn, public core::interfaces::i_on_entity_despawn {
        ...
        public:
            ...
            void on_entity_spawn(miscellaneous::game& game, core::types::entity const& entity) override {
                auto modules = entity.get_modules<math::modules::transform<Decimal, Size>, modules::appearance>();
                ...
                if (modules.has_value()) {
                    ...
                    auto agt = agent(0, transform, appearance);
...
REGISTER_SYSTEM("GraphicsSystem", dls::graphics::systems::graphics_t);
