...
namespace dls::input::systems {
    class input : public core::types::system<functions::poll>, public core::interfaces::i_on_scene_load, public core::interfaces::i_on_scene_unload {
        private:
        ...
        public:
            void on_scene_load(miscellaneous::game& game, core::types::scene const& scene) override {
            ...
            void on_scene_unload(miscellaneous::game& game, core::types::scene const& scene) override {
...
REGISTER_SYSTEM("InputSystem", dls::input::systems::input);
