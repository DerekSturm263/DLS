...
namespace dls::miscellaneous {
	class game {
		...
		public:
            ...
            void load_scene(core::types::scene& scene);
            void unload_scene(core::types::scene& scene);

            void spawn_entity(core::types::entity& entity);
            void despawn_entity(core::types::entity& entity);
