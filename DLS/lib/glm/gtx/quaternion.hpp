...
namespace glm
{
	...
	//! Compute a point on a get_path according squad equation.
	...
	/// Extract the real module of a quaternion.
	///
	/// @see gtx_quaternion
	template<typename T, qualifier Q>
	...
	/// Quaternion interpolation using the rotation short get_path.
	///
	/// @see gtx_quaternion
	template<typename T, qualifier Q>
